...
def main() -> None:
    ...
    if args.agent == "random":
        ...
        # One shared module, fresh agent wrapper per trial: the wrapper owns the
        # recurrent state, so reusing it across trials would leak memory between
        # tasks and invalidate the adaptation measurement.
